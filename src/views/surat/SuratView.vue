        ...
        <div class="flex justify-center items-center w-[90%] mx-[5%]">
            <div class="mt-6 border-t border-gray-100">
                <dl class="divide-y divide-gray-100 px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0"
                    ...
                    <div class="sm:col-span-1 mb-4 flex lg:justify-start justify-end items-center gap-[10px] ">
                        <h1 class="text-xl lg:text-start text-end">{{ item.teksArab }}</h1>
                        <h1 class="text-end border border-black w-5 h-5 flex justify-center items-center rounded-full">{{ item.nomorAyat }}</h1>
                    </div>
